...
const CATALOGS = {
  en: {
    ...
    "about.lead": "A window in front of the maps <strong>documentation.nvim</strong> generates. Two programs, and a bug usually belongs to one of them — which is what the block below is for.",
  ...
  de: {
    ...
    "about.lead": "Ein Fenster vor den Karten, die <strong>documentation.nvim</strong> erzeugt. Zwei Programme — und ein Fehler gehört meist zu einem von beiden. Dafür ist der Block unten da.",
